...
SELECT
    ...
    CASE
        WHEN T1.CODVEND = 29 THEN CASE WHEN SUM(R.VLRREBATEMKT) < 1 THEN 0 ELSE SUM(NVL(R.VLRREBATEMKT,0)) END
    ...
    CASE
        WHEN T1.CODVEND = 29 THEN
            SUM(NVL(VLRRESULTADO,0)) + CASE WHEN SUM(NVL(R.VLRREBATEMKT,0)) < 0.1 THEN 0 ELSE SUM(NVL(R.VLRREBATEMKT,0)) END
    ...
    CASE
        WHEN (CASE
                  WHEN T1.CODVEND = 29 THEN
                      SUM(VLRRESULTADO) + CASE WHEN SUM(R.VLRREBATEMKT) < 0.1 THEN 0 ELSE SUM(R.VLRREBATEMKT) END
