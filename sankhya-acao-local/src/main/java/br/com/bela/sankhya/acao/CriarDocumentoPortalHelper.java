...
final class CriarDocumentoPortalHelper {
    ...
    private void criarCabecalho() throws Exception {
        if (modeloCabecalhoVO != null) {
            cabecalhoNotaVO = DynamicVOHelper.duplicarCabecalhoNota(entityFacade, modeloCabecalhoVO, valoresCamposCabecalho);
            return;
        }
    ...
    private void criarItens() throws Exception {
        ...
        for (Map<String, Object> valoresItem : dadosItens) {
            ...
            if (!valoresItem.containsKey("VLRTOT") && valoresItem.containsKey("VLRUNIT") && valoresItem.containsKey("QTDNEG")) {
            ...
            PrePersistEntityState itePreState = PrePersistEntityState.build(entityFacade, "ItemNota", itemVO, null);
            itensNotaPPES.add(itePreState);
        }
        ...
        cacHelper.getClass()
                .getMethod("incluirAlterarItem", BigDecimal.class, AuthenticationInfo.class, Collection.class, boolean.class)
